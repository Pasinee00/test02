            ...
            <form name="form-add" action="" method="post">
              <table width="100%" border="0" cellpadding="1" cellspacing="1">
				  <tbody id="user-emptype">
					...
					?>
   					<tr>
   						<td width="28%" height="20" align="right">วันที่รับงาน : </td>
