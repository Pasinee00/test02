          ...
          <td colspan="2"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td><table width="220" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td width="" class="B">มีความประสงค์ขอแจ้งซ่อม</td>
                    </tr>
                </table></td>
                <td width="43%">&nbsp;</td>
                <td width="34%" align="center"><b>ผู้อนุมัติ</b></td>
              </tr>
              <tr>
                <td width="23%" valign="top"><b>แจ้งซ่อมงานระบบ</b></td>
                <td colspan="2"><?=$utilMD->convert2Thai($reqData['FRepairGroupItemName'])?></td>
              </tr>
        ...
        <tr>
          ...
          <td width="50%" class="L"><table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              ...
              <td colspan="3" height="250" class="" valign="top">&nbsp;<?=$utilMD->convert2Thai($reqData['FOth_detail'])?></td>
              <td width="3%">&nbsp;</td>
            </tr>
            <tr>
