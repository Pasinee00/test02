...
$param['t1.FBranchID_login'] = $userInfo['brn_id'];
  ...
  <div id="start-request">
	    ...
	    <div class="list-body" style="height: 69%;">
	  	  <div class="list-header">
		  	<ul>
		  		<li></li>
		  		<li style="width:15%;">Req-No.</li>
		  		<li style="width:15%;">Start Date</li>
		  		<li style="width:40%;">User</li>
	...
	function changePage(type){
		...
		$.ajax({ 
			...
			data: {"function":"get_data_section_list",
				   ...
				   "search[FBranchID_login][value]":$('#brn_id').val(),
				   "search[FBranchID_login][condition]":"=",
					...
					var ul = "<ul>";
						ul+= "<li></li>";
					  	...
					  	if(type=='new'){
							...
							ul+= "<li style=\"width:30%;\">"+cell['RequestName']+"</li>";
							if(cell['FStatus']=='inprogress'){
								ss = "กำลังดำเนินการ"
							}else{
								ss = "ตีกลับแก้ไข"
							}
							ul+= "<li style=\"width:15%;\">"+ss+"</li>";
						  ...
						  if(cell['status_closejob']==''){	
					  		...
					  		ul+= "<li style=\"width:21.33%;\"><span class=\"CloseJob2-icon\">ไม่รับงาน</span></li>";
							 ...
							 ul+= "<li style=\"width:21.33%;\"><span class=\"CloseJob2-icon\">รับงานเรียบร้อย</span></li>";
						  }
					  		ul+= "<li style=\"width:0.33%;\"></li>";
						}
					  	ul+= "<li></li>";
