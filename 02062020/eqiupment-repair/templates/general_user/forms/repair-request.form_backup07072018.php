                             ...
                             <table width="100%" border="0" cellspacing="1" cellpadding="1">
                                <tr>
                                   ...
                                   <td height="20" colspan="4">
                                   	  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                           <td width="7%" align="center"><input type="radio" name="fields[FJobresult]" id="FJobresult1" class="FJobresult_1" <? if($FJobresult=='1'){ ?> checked <? } ?> value="1" class="Noboder" ></td>
                                           <td width="19%">ซ่อมเอง </td>
                                           <td width="10%" align="center"><input type="radio" name="fields[FJobresult]" id="FJobresult2" class="FJobresult_2" <? if($FJobresult=='2'){ ?> checked <? } ?> value="2" class="Noboder" ></td>
	    	...
	    	$.ajax({
				...
				success: function(data){
					...
					if(data==1){
					    ...
					    if($('#user_type').val()=="AM"){
							if($('#FJobresult1').is(':checked')==false){
								AA = 0;
							}else{
								AA = 1;
							}
							if($('#FJobresult2').is(':checked')==false){
								BB = 0;
							}else{
								BB = 1;
							}
							if($('#FEstimate').val()==""){
								...
								buttons = eval(buttons);
								_confirm("warning","Warning","กรุณาระบุทำเองหรือจ้างทำ",buttons);
						 	}else if(supports=="0"){
								is_process = 0;
