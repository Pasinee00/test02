...
-
  <input type="text" name="fields[FReqTime]" id="FReqTime" readonly style="width:50px;" value="<?php print($time);?>"></td>
        ...
        <tr>
              <td width="18%" height="25">1.บริเวณที่ต้องการแจ้งซ่อม<font color="#FF0000">*</font></td>
            ...
            <input type="hidden" name="FPhoto_1" id="FPhoto_1"></td>
              <td>&nbsp;</td>
              <td width="17%">2.อุปกรณ์ที่ต้องการแจ้งซ่อม<font color="#FF0000">*</font></td>
	           ...
	           <td colspan="6">
                       ...
                       <tr>
                          <td width="50%" valign="top">
                            <table width="100%" border="0" cellspacing="1" cellpadding="1">
                                <tr>
                                   <td width="24%" height="20" align="left"><b>การทำงาน</b> :</td>
                                   <td height="20" colspan="4"><select name="fields[FJobresult]" id="FJobresult" class="uniform-select" onChange="chk_working('clr')">
                                            ...
                                            <option value="2">ให้ผู้รับเหมาดำเนินการ</option>
	           	  						 </select>
                                     </td>
                                 </tr>
                                  <tr>
                                   <td width="24%" height="20" align="left"><b>เก็บค่าใช้จ่ายผู้รับเหมา</b> :</td>
                                 ...
                                 <tr>
                                    <td height="20">&nbsp;</td>
                                    <td height="20" width="26%" ><b>ค่าแรง</b></td>
                                    <td height="20" width="14%" align="right">ราคา</td>
                                    ...
                                    <td width="14%" height="20" align="center">บาท</td>
                                 </tr>
                                ...
                                <tr>
                                 ...
                                 <tr>
                                		<td colspan="5">
                                				<table width="100%" border="0" cellspacing="0" cellpadding="0">
								           			<tr>
								           			   <td width="23%"><b>กำหนดเสร็จ</b> <font color="#FF0000">*</font> :</td>
											           ...
											           <td width="3%"></td>
											           <td width="19%"><b>วันที่เปิด Job</b> <?php if($userInfo['user_type']=="M"){?><font color="#FF0000">*</font><?php }?> :</td>
                                                     ...
                                                     <tr>
                                                     	 <td><b>สาเหตุที่ทำให้งานล่าช้า</b>  :</td>
                                                          <td>
                                                     ...
                                                     <tr>
                                                     <td><b>รายละเอียดที่ทำให้งานล่าช้า  :</b></td>
...
<script>
	...
	function onFileSelected(event,targetId,default_photo) {
		  ...
		  var buttons = '[{"title":"OK","class":"blue","action":""}]';
			...
			if(fsize > 1){
				_confirm("warning","Warning","กรุณาใช้รูปที่มีขนาดไม่เกิน 1 Mb",buttons);
	...
	function closeAll(){
		//alert($('#work_late').val());
		 if($('#work_late').val()=="" && $('#detail_worklate').val()==""){
				var buttons = '[{"title":"OK","class":"blue","action":""}]';
				buttons = eval(buttons);
				_confirm("warning","Warning","กรุณาระบุสาเหตุที่ทำให้งานล่าช้า",buttons);
    ...
    function saveData(){
    	if($('#FReqID').val()==""){
			...
			buttons = eval(buttons);
			_confirm("warning","Warning","กรุณาระบุการทำงาน",buttons);
			...
			buttons = eval(buttons);
			_confirm("warning","Warning","กรุณาระบุระดับความสำคัญ",buttons);
			...
			buttons = eval(buttons);
			_confirm("warning","Warning","กรุณาระบุรูปริเวณที่ต้องการแจ้งซ่อม",buttons);
			...
			buttons = eval(buttons);
			_confirm("warning","Warning","กรุณาระบุรูปอุปกรณ์ที่ต้องการแจ้งซ่อม",buttons);
