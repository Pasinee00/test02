      ...
      <table width="98%" align="center" border="0">
        ...
        <tr>
         ...
         <tr>
           ...
           <td>
           	 <select name="fields[FBranchID]" id="FBranchID" class="uniform-select" >
            	<option value="">---กรุณาเลือกสาขาที่ติดตั้ง</option>
         ...
         <tbody>
	        ...
	        <tr>
	         ...
	         <tr>
	           ...
	           <td>
	           		<select name="fields[FJobLevel]" id="FJobLevel" class="uniform-select" >
