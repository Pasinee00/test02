...
<body scrolling="no">
  <div class="content-top">
  	<div class="_content-title">งานส่งซ่อม/claim  </div>
  ...
  <table width="98%" align="center">
    <tr>
  		...
  		<td width="248"><select name="fields[FRepair_comp_id]" id="FRepair_comp_id" class="uniform-select" onChange="javascript:updateBranch('');javascript:updateSection('');">
  		...
  		<td width="78">สาขา :</td>
  		<td width="263"><select name="FBranchID" id="FBranchID" class="uniform-select" >
  		...
  		<td width="60">แผนก : </td>
  		<td width="229"><select name="sec_id" id="sec_id" class="uniform-select">
  ...
  <div class="list-body">
  	<div class="list-header">
	  	<ul>
	  		...
	  		<li style="width:25%;text-align:left">บริษัทที่ส่ง claim/ซ่อม</li>
	  		<li style="width:5%;">สถานะ</li>
	  		<li style="width:6%;">วันที่</li>
	  		<li style="width:16%;">Action</li>
	  		<li>
...
<script>
	...
	function openForm(id,no){
		...
		var h = 250;
		if(isNaN(id))id='';
		parent.TINY.box.show({iframe:'../eqiupment-repair/templates/administrator/forms/claim-information-form.php?id='+id+'&no='+no,boxid:'frameless',width:w,height:h,fixed:false,maskopacity:40});
	}
	function changePage(){
		$.ajax({ 
				...
				for(var i=0;i<rows.length;i++){
					...
					var ul = "<ul>";
						ul+= "<li></li>";
					  	...
					  	ul+= "<li style=\"width:25%;text-align:left;\">"+cell['FSuplierName']+"</li>";
					  	...
					  	ul+= "<li style=\"width:9.33%;\"><span class=\"shuffle-icon\" onclick=\"javascript:openForm('"+cell['FClaimID']+"','"+cell['FReqNo']+"');\">ส่งซ่อม/claim</span></li>";
					  	ul+= "<li></li>";
					    ul+= "<ul>";
