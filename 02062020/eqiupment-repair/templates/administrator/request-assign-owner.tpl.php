...
<body scrolling="no">
  <div class="content-top">
  	<div class="_content-title">กำหนดผู้รับผิดชอบงาน   </div>
  	<div class="search-action">
  	    <span class="new-status" style="padding-left:30px;padding-right:10px;">รอการ Assign</span>
  ...
  <table width="98%" align="center" border="0">
    ...
    <tr>
      ...
      <td><select name="status" id="status" class="uniform-select">
        ...
        <option value="new"   selected >---รอการ Assign---</option>
  ...
  <div class="list-body">
  	<div class="list-header">
	  	<ul>
	  		...
	  		<li style="width:19%;text-align:left">ผู้แจ้ง</li>
	  		<li style="width:10%;text-align:left">แผนก</li>
	  		<li style="width:15%;text-align:left">ประเภทงาน</li>
	  		<li style="width:11%;">สถานะ</li>
	  		<li style="width:11%;">วันที่</li>
