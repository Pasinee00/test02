...
if($totalRequest>0){
	...
	$finishedPercent = (($finishedPercent)/$totalRequest)*100;
}
...
<body scrolling="no">
  ...
  <div id="new-request">
	    <div class="content-top" style="width: 95%;">
		  	<div class="_content-title">คำร้องใหม่ (รอการ Assign)</div>
	    </div>
  ...
  <div id="start-request">
  	  <div class="content-top" style="width: 95%;">
		  	<div class="_content-title">คำร้องกำลังดำเนินการจาก Support</div>
	    </div>
	    <div class="list-body" style="height: 69%;">
	  	  <div class="list-header">
		  	<ul>
  ...
  <div id="closejob-request">
  	    <div class="content-top" style="width: 95%;">
		  	<div class="_content-title">คำร้องการไม่ตรวจรับงาน</div>
	    </div>
	    <div class="list-body" style="height: 69%;">
	  	  <div class="list-header">
		  	<ul>
		  		...
		  		<li style="width:19%;">Req-No.</li>
		  		<li style="width:19%;">Date</li>
		  		<li style="width:33%;text-align:left;">Employee Request</li>
		  		<li style="width:24%;">Action</li>
            </ul>
		</div>
		<div class="list-items preloading" >
	   ...
	   <div class="list-paging">
	  		...
	  		<div class="paging-action">
	  			<ul class="nav-page">
	  				...
	  				<li class="paging-select">
	  					<select id="select-page-closejob" onchange="javascript:changePage('closejob');"></select>
	  				</li>
...
<script>
	...
	//	alert(type);
		...
		$.ajax({ 
			...
			data: {"function":"get_data_section_list",
				   ...
				   "search[t1.FStatus][condition]":"in",
			 	   "status_where_close_dis":1   //ส่งค่าตัวแปรไปเปรียบใน function get_data_section_list ว่า status_closejob == '2'
			}
		})
		.success(function(results) { 
					...
					var ul = "<ul>";
						ul+= "<li></li>";
					  	...
					  	if(type=='new'){
					  		...
					  		ul+= "<li style=\"width:11.33%;\"><span class=\"assign-support-icon\" onclick=\"javascript:openPopup('"+cell['FRequestID']+"');\">Assign</span></li>";
						  	ul+= "<li style=\"width:12.33%;\"><span class=\"remove-icon\" onclick=\"javascript:cancelReq('"+cell['FReqNo']+"',"+cell['FRequestID']+");\">Cancel</span></li>";
						}else if(type=="start"){
							//alert(cell['approve_date'])
							...
							}else if(cell['FStatus']=='returnedit'){
					  		ul+= "<li style=\"width:15.33%;\">ตีกลับแก้ไข</li>";
							}
							ul+= "<li style=\"width:15%;\"><span class=\"info-icon\" onclick=\"javascript:openInformation('"+cell['FRequestID']+"');\">Information</span></li>";
							...
							//ul+= "<li style=\"width:11.33%;\"><span class=\"office-folder-icon\" onclick=\"javascript:receiveDoc('"+cell['FRequestID']+"');\">Receive</span></li>";
					  		ul+= "<li style=\"width:0.33%;\"></li>";
						}else if(type=="closejob" && cell['status_closejob']=='2'){ 
							ul+= "<li style=\"width:29%;text-align:left;\">"+cell['RequestName']+cell['FBranchID']+cell['FBranchID_login']+"</li>";
						 	ul+= "<li style=\"width:31.66%;\"><span class=\"CloseJob1-icon\" onclick=\"javascript:check_closejob('"+cell['FRequestID']+"');\">แก้ไขงาน</span></li>";
						    ul+= "<li style=\"width:0.33%;\"></li>";	
						}
			...
			else if(type=='assing')setTimeout("changePage('closejob')",1000);
			else if(type=='closejob')setTimeout("changePage('new')",1000);
			//else if(type=='closejob')setTimeout("changePage('new')",6000);
		});
	...
	function check_closejob(id){
		...
		if(isNaN(id))id='';
		parent.TINY.box.show({iframe:'../eqiupment-repair/templates/informations/closejob-emp-request.php?id='+id,boxid:'frameless',width:800,height:390,fixed:false,maskopacity:40});
    }
	function check_closejobDO(id){
		...
		var h = screen.height-10;
		if(isNaN(id))id='';
		parent.TINY.box.show({iframe:'../eqiupment-repair/templates/informations/closejob-emp-requestDO.php?id='+id,boxid:'frameless',width:800,height:250,fixed:false,maskopacity:40});
    }
</script>
</html>