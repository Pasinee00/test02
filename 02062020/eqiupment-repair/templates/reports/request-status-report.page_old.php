...
<body><table width="100%" border="1" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td width="7%" align="center" bgcolor="#FFFFE1" style="font-weight: bold">ค่าแรง</td>
    <td width="7%" align="center" bgcolor="#FFFFE1" style="font-weight: bold">ค่าอะไหล่</td>
    <td width="7%" align="center" bgcolor="#FFFFE1" style="font-weight: bold">สรุปงาน</td>
  </tr>
  ...
  <tr>
    ...
    <td align="center"><?=number_format($row->FLapAmt,2)?></td>
    <td align="center"><?=number_format($row->FPartAmt,2)?></td>
    <td align="center"><?=$row->FOth_detail?></td>
  </tr>
  <? } ?>
</table>
