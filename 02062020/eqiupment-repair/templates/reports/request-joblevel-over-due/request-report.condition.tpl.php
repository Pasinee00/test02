...
<body>
   <div class="dialog-panel condition-panel">
   		<div class="top-row">
   			<div class="left"></div>
   			<div class="center">
   				<span class="dialog-title">รายงานประเภทงานที่เกินกำหนด</span>
   			</div>
   			<div class="right"></div>
   		</div> 
   		<div class="middle-row" style="height:100%;">
   			...
   			<div id="dialog-body" class="center">
                   ...
                   <tr>
   							<td style="width:15%"><strong>บริษัท :</strong></td>
   				   ...
   				   <tr>
   						<td style="width:15%"><strong>สาขา :</strong></td>
   					 ...
   					 <tr>
   						<td><span style="width:15%"><strong>แผนก :</strong></span></td>
   					...
   					<tr>
   						...
   						<td colspan="2" style="width:38%">
   							<input type="text" name="SRequestDate" id="SRequestDate" style="width:100%;" value="">-<input type="text" name="ERequestDate" id="ERequestDate" style="width:100%;" value="">
   						</td>
   						<td style="width:13%"><strong>วันที่รับเรื่อง :</strong></td>
   						<td colspan="2" style="width:44%">
   							<input type="text" name="SReciveDate" id="SReciveDate" style="width:100%;" value="">-<input type="text" name="EReciveDate" id="EReciveDate" style="width:100%;" value="">
   						</td>
   					</tr>
   					<tr>
   						<td><strong>ประเภทงาน :</strong></td>
   						<td colspan="5">
   							<select name="FJobLevel" id="FJobLevel" class="uniform-select" >
...
$(document).ready(function() {
	 ...
	 $('#SReciveDate').Zebra_DatePicker();
	 $('#EReciveDate').Zebra_DatePicker();
...
function new_oldWindow(){
	...
	params +="&SReciveDate="+$('#SReciveDate').val();
	params +="&EReciveDate="+$('#EReciveDate').val();
	params +="&JobLevel="+$("#FJobLevel").val();
    params +="&status=excel";
