...
<body>
   <div class="dialog-panel condition-panel">
   		<div class="top-row">
   			<div class="left"></div>
   			<div class="center">
   				<span class="dialog-title">รายงานสรุปประจำเดือน</span>
   			</div>
   			<div class="right"></div>
   		</div> 
   			...
   			<div id="dialog-body" class="center">
   				<table width="100%" border="0">
                	<tr>
   				   ...
   				   <tr>
   						<td style="width:10%"><strong>สาขา :</strong></td>
   					 ...
   					 <tr>
   						<td><span style="width:10%"><strong>แผนก :</strong></span></td>
   					...
   					<tr>
   						...
   						<td style="width:13%"><strong>กำหนดเสร็จ :</strong></td>
   			...
   			<div class="center">
   				<table width="100%">
   			    	<tr>
   			    		...
   			    		<td align="right">
   			    				<?php /* <a class="button-bule" href="javascript:void(0);" onclick="javascript:up_nature();">111</a> */?> <a class="button-bule" href="javascript:void(0);" onclick="javascript:newWindow();"> ออกรายงาน  </a>
   			    		</td>
   			    	</tr>
   			    </table>
   			</div>
