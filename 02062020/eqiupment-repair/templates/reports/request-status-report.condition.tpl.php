...
<body>
   <div class="dialog-panel condition-panel">
   		<div class="top-row">
   			<div class="left"></div>
   			<div class="center">
   				<span class="dialog-title">รายงานติดตามสถานะงานซ่่อม</span>
   			</div>
   			<div class="right"></div>
   		</div> 
   					...
   					<tr>
   						...
   						<td colspan="5">
   							<select class="uniform-select" name="FStatus" id="FStatus">
	   						  ...
	   						  <option value="finished">---ทำการแก้ไขเรียร้อยแล้ว---</option>
...
function newWindow(){
	...
	params +="&FStatus="+$('#FStatus').val();
	newwindow=window.open('request-status-report.page.tpl.php?'+params,
