...
<body>
   <div class="dialog-panel condition-panel">
   		<div class="top-row">
   			<div class="left"></div>
   			<div class="center">
   				<span class="dialog-title">รายงานสรุปประสิทธิภาพการทำงาน ตามประเภทงานซ่อม L,M,H</span>
   			</div>
   			<div class="right"></div>
   		</div> 
...
function newWindow(){
	...
	newwindow=window.open('request-support-TypeJob-report.page.tpl.php?'+params,
