 	...
 	function insert_data($fields,$id){
		...
		$id = $_array['req_id'];
			...
			if($num_check_mail>='1'){
				...
				$mail->FromName = iconv("tis-620","utf-8","เชิญอนุมัติงานใบ MT REQUEST จากระบบ Approv Center");
				$mail->AddAddress($record_mail_manager[email_company], 1);
				$mail->WordWrap = 50;	// Set word wrap to 50 characters
				$mail->isHTML(true);// Set email format to HTML
				$mail->Subject = iconv("tis-620","utf-8","ระบบ Approv Center เชิญอนุมัติงาน ใบ MT REQUEST"); 
