 	...
 	function insert_data($fields,$REQUEST){
		...
		$sql_check_mail = "SELECT
			...
			if($num_check_mail>='1'){
				...
				$mail->Subject = "เรียนเชิญ คุณ".iconv("tis-620","utf-8",$rowCHKmail[emp_name])." (".iconv("tis-620","utf-8",$rowCHKmail[post_name]).") เซ็นต์อนุมัติเอกสารขอความเห็นชอบและอนุมัติแผนกซ่อมบำรุง เลขที่ $rowCHKmail[Fdoc_app_no]  ผ่านระบบ Approve Center";
